export class SimpleImage {
  ...
  render() {
    ...
    input.addEventListener('change', (event) => {
      ...
      if (file) {
        ...
        reader.onload = (e) => {
          imgPreview.src = e.target.result; // Set image preview source
  ...
  save(blockContent) {
    const iframeElement = blockContent.querySelector('iframe');
    return {
      url: iframeElement ? iframeElement.src : '',
    };
  }
}