export class Video {
    ...
    render() {
      // Create a wrapper div to hold the input and video preview
      const wrapper = document.createElement('div');
  
      // Create input element for URL input
      ...
      // Create iframe element to display the video
      const videoPreview = document.createElement('iframe');
      videoPreview.style.width = '100%';
      videoPreview.style.height = '315px';
      videoPreview.style.display = 'none'; // Initially hidden until a valid URL is entered
      videoPreview.setAttribute('frameborder', '0');
      videoPreview.setAttribute('allow', 'accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture');
